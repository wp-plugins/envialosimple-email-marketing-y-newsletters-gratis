...
1. Agregar el Plugin utilizando la Administración de Wordpress, o bien subiéndolo por FTP.
2. Activar el Plugin, desde la sección Plugins de Wordpress.
3. Ir al Menú EnvialoSimple -> Configuración .
4. Ingrese los datos de su Cuenta, o bien cree una Cuenta Nueva Gratis.
5. Ya puede comenzar a crear y enviar sus Newsletters.

== Screenshots ==

1. Pantalla de Configuración Inicial.
2. Vista del Editor de Newsletters con una Plantilla.
3. Seleccionando un bloque para su Edición.
4. Editando Texto.
5. Arrastrando y Soltando un Nuevo Bloque de Contenido Wordpress.
6. Pantalla de Selección de Posts para Incorporar al Newsletter.
7. Vista del Post Agregado en el Contenido.
8. Pantalla de Importar Contactos. 
9. Pantalla de Formularios de Suscripción. 
