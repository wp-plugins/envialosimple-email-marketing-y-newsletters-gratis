...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: "{file} tiene una extensión inválida. Extension válida): {extensions}.",
            sizeError: "{file} es muy grande, el máximo es {sizeLimit}.",
            minSizeError: "{file} is too small, minimum file size is {minSizeLimit}.",
            emptyError: "{file} está vacío, please select files again without it.",
            noFilesError: "No hay archivos para subir.",
            onLeave: "Hay archivos que están siendo subidos, si abandonas la página, la subida se cancelará."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            failUpload: 'La subida Falló',
            dragZone: 'Soltar archivos aquí para subir',
        ...
        messages: {
            tooManyFilesError: "Solo podés soltar un archivo a la vez."
        },
        retry: {
            showAutoRetryNote: true,
            autoRetryNote: "Reintentando {retryNum}/{maxAuto}...",
            showButton: false
        },
