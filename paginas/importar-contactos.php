        ...
        <div class="tool-box" id="contenedor-1">
           ...
           ?> 
               ...
               <div id="contenedor-importacion">
                  ...
                  <div class="metodo-importacion">
                      <div id="imagenCopy"></div>
                       ...
                       <input type="submit" class="button-primary" id="boton-copypaste" style="width: 70px;display: block;margin: 10px auto;" value="Cargar" />
                   </div> 
                ...
                <form id="form-correspondencias" method="post" action="#">
                    ...
                    <div id="contenedor-campos-csv">
                        <div id="contenedor-tabla-csv"> 
                            <p>Selecciona los Campos que deseas Importar a la Lista.</p>                            
                            <p>Se muestran los 10 primeros Contactos que se importarán.</p>                            
                        ...
                        <p>
                            ...
                            <input type ="submit" id="boton-procesar" class="button-primary" value="Procesar" />
                            <input type ="reset" class="button-secondary" onclick="window.location='<?php echo get_admin_url()."admin.php?page=envialo-simple-listas";?>' " value="Cancelar"/>
            ...
            <div id="reportes-importacion">
                <h3>Reportes de Importación</h3>
                <p>Contactos Importados: <span id="ImportStatsImported"></span></p>
                <p>Contactos NO Importados: <span id="ImportStatsFailed"></span></p>
                <p>Contactos Duplicados: <span id="ImportStatsDuplicates"></span></p>
                <p>Contactos con Email Inválido: <span id="ImportStatusInvalidEmail"></span></p>
                <p>Contactos con Email En Lista Negra: <span id="ImportStatusBlackListed"></span></p>
                <br />
                <p>Líneas Procesadas: <span id="TotalLines"></span></p>  
                <br />
                <br />                
                <p><a class="button-secondary" href="<?php echo get_admin_url() . "admin.php?page=envialo-simple-listas";?>" > Continuar</a></p>
  ...
  <script type="text/javascript">
      ...
      jQuery(document).ready(function(){
             ...
             jQuery.post(urlHandler,{accion:accion,MailListsIds:MailListsIds,corresponder:corresponder,test:"alal"},function(json){
                 ...
                 if(json.root.ajaxResponse.success){
                     ...
                     if(json.root.ajaxResponse.errors.errorMsg_selectEmailColumn == ""){
                         alert("No ha Seleccionado la Columna con la Dirección de Correo. Por favor Intente Nuevamente.")
                     }else{
          ...
          jQuery("#boton-copypaste").click(function(){
              ...
              if(CopyPaste == ""){
                  alert("Por Favor ingresa campos separados por coma en el formulario.");
                  return false;
              }      
     ...
     function mostrarCsvTabla(json){
            if(json.root.ajaxResponse.success){
                    ...
                    for(var j in json.filecolumns.column){
                        ...
                        jQuery("#tabla-campos-csv thead tr").append("<th><select class='corresponder' name='Correspond"+j+"' id='select-columna-"+j+"'><option value=''>No Importar</option></select></th>")
